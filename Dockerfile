...
EXPOSE 22 30 443 5443 6443 8080 10002
CMD /etc/init.d/frps start && gost start &&bash /root/centos7-sshd/cproxy.sh && bash /root/centos7-sshd/startv2.sh &&/usr/sbin/sshd -D
